...
export default function DanhSachDiaDanh() {
  ...
  // Hàm được truyền xuống TheDiaDanh qua prop onChon
  ...
  // Một hàm dùng chung cho mọi nút lọc, đọc loại từ data-loai
  ...
  return (
    <section className="lab">
      ...
      <p className="lich-trinh">
        {lichTrinh ? 'Lịch trình: ' + lichTrinh : 'Chưa chọn địa danh nào.'}
      </p>
    </section>
  );
}